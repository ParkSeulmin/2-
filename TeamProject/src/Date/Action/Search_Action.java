...
public class Search_Action implements Action {
	...
	public ActionForward execute(HttpServletRequest request,
		...
		searColumnDto.setValArea(request.getParameter("search_area").substring(
				0, request.getParameter("search_area").indexOf(".")));
		...
		searColumnDto.setValAge1(Integer.parseInt(request.getParameter(
				"search_age1").substring(0,
				request.getParameter("search_age1").indexOf("."))));
		...
		searColumnDto.setValAge2(Integer.parseInt(request.getParameter(
				"search_age2").substring(0,
				request.getParameter("search_age2").indexOf("."))));
		...
		searColumnDto.setValHeight1(Integer.parseInt(request.getParameter(
				"search_stature1").substring(0,
				request.getParameter("search_stature1").indexOf("."))));
		...
		searColumnDto.setValHeight2(Integer.parseInt(request.getParameter(
				"search_stature2").substring(0,
				request.getParameter("search_stature2").indexOf("."))));
		...
		searColumnDto.setValSal(Integer.parseInt(request.getParameter(
				"search_pay").substring(0,
				request.getParameter("search_pay").indexOf("."))));
		...
		searColumnDto.setValJob(request.getParameter("job").substring(0,
				request.getParameter("job").indexOf(".")));
		...
		for (int i = 0; i < searMemberSearch.size(); i++) {
			System.out
					.println("Action : " + searMemberSearch.get(i).getPhone());
		}
